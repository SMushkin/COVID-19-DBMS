...
class Application:
    def __init__(self, master):
        ...
        # aadhar
        self.Aadhar = Label(self.left, text="Appointment Time", font=('arial 18 bold'), fg='black', bg='lightgreen')
        self.Aadhar.place(x=0, y=260)
        ...
        self.Aadhar_ent = Entry(self.left, width=30)
        self.Aadhar_ent.place(x=250, y=260)
    ...
    def add_appointment(self):
        ...
        if self.val1 == '' or self.val2 == '' or self.val3 == '' or self.val4 == '' or self.val5 == '':
            ...
            sql = "INSERT INTO 'appointments' (Name, Age, Gender, location, Aadhar, Phone) VALUES(?, ?, ?, ?, ?, ?)"
